    ...
    <div class="insert-panel">
    	...
    	<form action="includes/createprod.inc.php" method="POST">
            <div class="inserbox-container">
                 ...
                 <div class="insertbox" id="cp">Capital Price <input type="text" name="capitalprice" required>
                 </div>
                 <div class="insertbox" id="sp">Sell Price <input type="text" name="sellprice" required>
                 </div>                      
           </div>
